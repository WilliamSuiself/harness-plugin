...
export function buildOverridePrompt(customWords = []) {
  ...
  return [
    ...
    '       b. map kind: anything non-secret (手机号/地址/姓名/身份证/公司/项目/计划/家庭事务) → kind=note (optionally add tags[] / dueDate); API Key/Token/密码/Secret → kind=credential',
    ...
    '  ✅ "[<your code-word>] 把我的手机号 138-1234-5678 存成 主手机号" → call memorypets_upsert kind=note label=主手机号 value=138-1234-5678.',
